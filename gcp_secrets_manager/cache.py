...
class SecretManagerWithCache:
    ...
    def __init__(self, project_id: str, cache_ttl_seconds: int = 300):
        ...
        logger.info(f"SecretManager inicializado para proyecto '{project_id}' con TTL de {cache_ttl_seconds}s")
    ...
    def get_secret(self, secret_name: str, validate_name: bool = True) -> Optional[str]:
        ...
        # Obtener de GCP
        logger.info(f"Secreto '{secret_name}' NO encontrado en caché o expirado. Obteniendo de GCP...")
        try:
            ...
            logger.warning(f"El secreto '{secret_name}' no fue encontrado en el proyecto '{self.project_id}'.")
            return None
    ...
    def get_multiple_secrets(self, secret_names: List[str], 
                           validate_names: bool = True) -> Dict[str, Optional[str]]:
        """
