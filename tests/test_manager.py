...
class TestStandardSecretsManager:
    ...
    def test_get_db_credentials(self, manager):
        ...
        with patch.object(
            manager.sm_client, "get_secret", side_effect=lambda x: mock_values.get(x)
        ):
    ...
    def test_get_cache_status(self, manager):
        ...
        mock_cache_info = {"total_secrets": 5, "ttl_seconds": 300, "secrets": {}}

        with patch.object(manager.sm_client, "get_cache_info", return_value=mock_cache_info):
